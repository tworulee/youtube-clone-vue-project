  ...
  <v-app>
    <v-navigation-drawer v-model="drawer" app clipped flating temporary>
      <v-list>
        ...
        <v-list-item v-for="item in items" :key="item.icon" links>
          <v-list-item-action>
          ...
          <v-card>
            <v-list>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Tuğrul Yüce</v-list-item-title>
            ...
            <v-card-actions>
              <v-spacer />
              <v-btn color="primary" text @click="menu = false"> Çıkış </v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </div>
          ...
          >
            <v-card>
              ...
              <v-card-text class="text-primary"
                ...
                <div>Başlık İçeriği</div></v-card-text
              >
              <v-card-actions>
